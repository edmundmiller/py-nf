 ...
 */
async function detectPyNf($: any): Promise<DetectionResult> {
 ...
 */
async function hasUv($: any): Promise<boolean> {
  try {
 ...
 */
async function installPyNf($: any): Promise<{ success: boolean; error?: string }> {
...
export const PyNfPlugin: Plugin = async ({ $ }) => {
